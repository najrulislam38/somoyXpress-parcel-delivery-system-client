...
export default function Footer() {
  return (
    <footer className="bg-white dark:bg-sidebar border-t dark:text-white">
      <div className="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
                ...
                <li>
                  ...
                  >
                    <svg
                      ...
                      className="size-5 shrink-0 text-gray-900 dark:text-white shadow-sm"
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                      strokeWidth="2"
        ...
        <div className="mt-12 border-t border-gray-100 pt-6 ">
          <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0 text-center">
            &copy; {new Date().getFullYear()} All rights reserved by SomoyXpress
            Courier.
          </p>
        </div>
      </div>
